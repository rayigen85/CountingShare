...
/**
 * Created by rayig on 03.02.2018.
 */

public class PasswordResetCom {

    public Map<String, Object> sendToServer(final String email){
        Map<String, Object> answer = new HashMap<String, Object>();

        try {
            String textparam = "user_email=" + URLEncoder.encode(email, "UTF-8");

            URL scripturl = new URL("https", "raybit.de", 443, "/app/reset_password.php");
